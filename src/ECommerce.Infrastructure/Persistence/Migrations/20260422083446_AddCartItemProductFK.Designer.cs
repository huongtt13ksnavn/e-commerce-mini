...
namespace ECommerce.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260422083446_AddCartItemProductFK")]
    partial class AddCartItemProductFK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.Cart", b =>
                {
                    b.OwnsMany("ECommerce.Domain.Entities.CartItem", "Items", b1 =>
                        {
                            ...
                            b1.HasOne("ECommerce.Domain.Entities.Product", null)
                                .WithMany()
                                .HasForeignKey("ProductId")
                                .OnDelete(DeleteBehavior.Restrict)
                                .IsRequired();

                            b1.OwnsOne("ECommerce.Domain.ValueObjects.Money", "UnitPrice", b2 =>
                                {
